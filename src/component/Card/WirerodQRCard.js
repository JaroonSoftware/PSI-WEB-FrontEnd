...
import { Card, Row, Col, QRCode } from "antd";
...
const WireRodQrCard = forwardRef(({ printData }, ref) => {
  return (
    <div ref={ref}>
      {printData.map((data, index) => (
        <Card title={null} style={{ marginBottom: "8px" }} key={index}>
          <table style={{ border: "1px solid", width: "100%" }}>
            ...
            <tr>
              ...
              <td style={valueStyled}>{data.weight?.toLocaleString()} KGs.</td>
            </tr>
          </table>
        </Card>
      ))}
